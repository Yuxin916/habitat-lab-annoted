...
"""
change working directory to habitat-lab
"""
# Create a directory to store the images
IMAGE_DIR = os.path.join("tutorial", "images")
...
def example_get_topdown_map():
    """
    This function demonstrates how to get a top-down map from the simulator
    ...
    with habitat.Env(config=config, dataset=dataset) as env:
        ...
        imageio.imsave(
            os.path.join(IMAGE_DIR, "top_down_map_hm3d.png"), top_down_map
        )
